...
# bRange = 2
# Describe the test
testDescript = 'Counterfactual Test Model 1'
...
# Stage and BMI too high or low decrease recovery chances.

# python synth/synthDataGen.py models/cfTest.py 100000
# python counterfactualTest.py models/cfTest.py
