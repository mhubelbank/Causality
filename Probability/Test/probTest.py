...
def run(filename):
    ...
    ivcGupper = ps.E('IVC', ('IVA', upper - .05, upper + .05), power =5)
    ivcGlower = ps.E('IVC', ('IVA', lower - .05, lower + .05), power =5)
    print('E( IVC | IVA = upper)', ivcGupper)
    print('E( IVC | IVA = lower)', ivcGlower)
    ivcGupper = ps.E('IVC', [('IVA', upper - .05, upper + .05), 'IVB'], power =5)
    ivcGlower = ps.E('IVC', [('IVA', lower - .05, lower + .05), 'IVB'], power=5)
