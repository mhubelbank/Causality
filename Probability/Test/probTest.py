...
def run(filename):
    ...
    print('A _||_ B = ', ps.independence('A', 'B'), ps.isIndependent('A', 'B'), ' Exp: > .1, True')
    print('A _||_ C = ', ps.independence('A', 'C'), ps.isIndependent('A', 'C'), ' Exp: < .1, False')
    print('A _||_ B | C = ', ps.independence('A', 'B', 'C'), ps.isIndependent('A', 'B', 'C'), ' Exp: <.1, False')
    print('A _||_ N = ', ps.independence('A', 'N'), ps.isIndependent('A', 'N'), ' Exp: > .1, True')
    print()
    ...
    ivcGupper = ps.E('IVC', ('IVA', upper - .05, upper + .05))
    ivcGlower = ps.E('IVC', ('IVA', lower - .05, lower + .05))
    print('E( IVC | IVA = upper)', ivcGupper)
    print('E( IVC | IVA = lower)', ivcGlower)
    ivcGupper = ps.E('IVC', [('IVA', upper - .05, upper + .05), 'IVB'])
    ivcGlower = ps.E('IVC', [('IVA', lower - .05, lower + .05), 'IVB'])
